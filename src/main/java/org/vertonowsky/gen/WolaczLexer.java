...
public class WolaczLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "TOINT", "TOFLOAT", "FTYPE", "WRITE", "READ", 
			"FUNCTION", "ENDFUNCTION", "REPEAT", "ENDREPEAT", "IF", "ENDIF", "STRING", 
			"BOOL", "ID", "INT", "FLOAT", "FLOAT64", "ADD", "MULT", "DIV", "SUB", 
			"AND", "OR", "XOR", "NEG", "NEWLINE", "WS"
		};
	}
